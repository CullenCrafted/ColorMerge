...
export interface ColorMergeState {
  currentColor: Color;
  targetColor: Color;
...
export class ColorMergeLogic {
  ...
  public static restore(state: ColorMergeState): ColorMergeLogic {
    const game = Object.create(ColorMergeLogic.prototype) as ColorMergeLogic;
